...
// 내가 파악한 방법
// 1. 카드 덱을 정수로 판단하고 출력할때 그 정수값에 따라 문양 출력
// 2. 카드를 섞고 플레이어에게 준다 == 정렬된 카드를 플레이어에게 랜덤으로 준다


// 구현 못한 부분 : 하드코딩을 한 이외의 대부분을 모듈화를 하지 못하였음

// 수정해야 할 부분 :  교수님이 처음 코드 보고 혈압이 오르실 정도의 절차지향적 하드코딩입니다. 모듈화를 생각해보겠습니다.
